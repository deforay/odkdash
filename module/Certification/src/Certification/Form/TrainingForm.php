...
class TrainingForm extends Form {
    ...
    public function getListProvider() {
        ...
        $sql = 'SELECT certification_id,last_name,first_name,middle_name FROM provider order by last_name asc ';
        ...
        foreach ($result as $res) {
            $selectData[$res['certification_id']] = $res['last_name'].' '. $res['first_name'].' '. $res['middle_name'];
