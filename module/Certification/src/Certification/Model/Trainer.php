...
class Trainer {
    ...
    public function exchangeArray($data) {
        ...
        $this->trainer_middle_name = (!empty($data['trainer_middle_name'])) ? $data['trainer_middle_name'] : null;
        $this->region = (!empty($data['region'])) ? $data['region'] : null;
        $this->district = (!empty($data['district'])) ? $data['district'] : null;
        $this->phone = (!empty($data['phone'])) ? $data['phone'] : null;
        $this->email = (!empty($data['email'])) ? $data['email'] : null;
        $this->job_address = (!empty($data['job_address'])) ? $data['job_address'] : null;
